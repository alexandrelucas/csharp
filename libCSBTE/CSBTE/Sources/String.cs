...
namespace CSBTE
{
    public class StringUtil
    {
        ...
        /// <summary>
        /// Generates a random string (eg: password)
        /// </summary>
        /// <param name="length">String length</param>
        /// <param name="content">Content type (0 for letters or Numbers 1 to only numbers, letters only for 2.)</param>
        /// <param name="casing">Casing (0 to High or low letters, 1 for high letters, 2 letters to low</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns to a letter the following code in the ASCII table
        /// </summary>
        ...
        /// <summary>
        /// Returns a code following the letter in the ASCII table
        /// </summary>
        ...
        public static string SpaceToUnderline(string str)
        {
            if (string.IsNullOrEmpty(str)) return string.Empty;
