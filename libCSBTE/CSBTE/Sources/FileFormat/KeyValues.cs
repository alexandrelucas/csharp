...
namespace CSBTE.FileFormat
{
    ...
    public class KeyValue
    {
        ...
        private void RecursiveSaveToFile(System.IO.FileStream f)
        {
            RecursiveSaveToFile(f, 0);
        }

        private void RecursiveSaveToFile(System.IO.FileStream f, int indentLevel)
        {
            // write header
        ...
        private void WriteIndents(System.IO.FileStream f, int indentLevel)
        {
            WriteString(f, new string('\t', indentLevel));
        }

        private static void WriteString(System.IO.FileStream f, string str, bool quote = false)
        {
